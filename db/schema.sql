-- MIT ADT Transport & Faculty Services Portal
-- PostgreSQL source-of-truth schema. This file is deliberately backend-only;
-- it does not alter the existing Figma Make React UI.
